// 32-bit ALU supporting all RV32I R-type and I-type operations.
// Uses a shared adder for ADD/SUB/compare; flags (N,Z,C,V) are valid for arithmetic ops.
module alu(
    input         [31:0] a_in,
    input         [31:0] b_in,
    ...
    wire        N, Z, C, V;
    // Negate b for SUB, SLT, and SLTI to reuse the adder as a subtractor
    ...
    // Adder flags are valid for arithmetic/compare ops; others derive flags from result directly
    always @(*) begin
        case(ALUControl)
